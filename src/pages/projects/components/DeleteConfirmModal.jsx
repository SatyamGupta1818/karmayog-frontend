...
export default function DeleteConfirmModal({ open, project, loading, onCancel, onConfirm }) {
      ...
      >
        <div className="px-6 pb-4 pt-6">
          ...
          <p className="text-sm leading-6 text-ink-muted">
            Are you sure you want to delete <span className="font-semibold text-ink">"{project.name}"</span>?
          </p>
        </div>
