      ...
      >
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="mt-0.5 text-xs text-ink-muted">
                {mode === 'create'
                  ? 'Add a department for organizing teams.'
        ...
        <form onSubmit={handleSubmit} className="space-y-4 px-6 py-5">
          ...
          <label className="flex items-center justify-between rounded-xl border border-surface-200 bg-surface-50 px-4 py-3">
            <span>
              <span className="block text-sm font-semibold text-ink">Active Department</span>
              <span className="block text-xs text-ink-muted">Inactive departments remain visible.</span>
            </span>
            <input
              type="checkbox"
